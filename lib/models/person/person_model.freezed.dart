...
class _$_Person implements _Person {
  ...
  @override
  String toString() {
    return 'Person(birthYear: $birthYear, deathYear: $deathYear, name: $name)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, birthYear, deathYear, name);
...
abstract class _Person implements Person {
  const factory _Person(
      ...
      @JsonKey(name: 'death_year') final String? deathYear,
